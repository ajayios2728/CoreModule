...
class English:LanguageProtocol {
    ...
    lazy var Circular: String = {return "Circular"}()
    lazy var Discussion: String = {return "Discussion"}()
    lazy var Calculation: String = {return "Calculation"}()
    lazy var More: String = {return "More"}()
    ...
    lazy var Forgot_Password: String = {return "Forgot Password"}()
    ...
    lazy var You_all_set : String = {return "You're all set."}()
    lazy var Collaboration_with_your_Team : String = {return "Collaboration with your Team"}()
